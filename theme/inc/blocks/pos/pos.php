<?php
	...
	if(get_field('use_custom_content')):
		...
		$b1SocialProfiles = get_field('add_social_media');
		...
		$b1TitleOne = get_field('b1_title_part_one','option');
		$b1TitleTwo = get_field('b1_title_part_two','option');
		$b1Content = get_field('b1_content','option');
		$b1SocialLabel = get_field('b1_social_handle_label','option');
		$b1SocialLink = get_field('b1_social_handle_link','option');
		$b1SocialProfiles = get_field('add_social_media','option');
		$b2TitleOne = get_field('b2_title_part_one','option');
		$b2TitleTwo = get_field('b2_title_part_two','option');
		$b2Content = get_field('b2_content','option');
		$b2Form = get_field('form_code','option');
   	...
   	<div class="ccc26_wrap ccc26_pos-columns">
        ...
        <div class="ccc26_pos-column ccc26_background-pink">
            ...
            <div class="ccc26_pos-column-content">
                ...
                <p>
					<?php if($b1SocialLink): ?>
						<a class="tag" href="<?php echo $b1SocialLink; ?>" target="_blank" rel="noopener noreferrer">
							<?php echo $b1SocialLabel; ?>
						</a>
					<?php else: ?>
						<span class="tag">
							<?php echo $b1SocialLabel; ?>
